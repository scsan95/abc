...
public class BookDao implements Closeable
{
	...
	{
		this.insertStatement.setInt(1, book.getId());
		this.insertStatement.setString(2, book.getName());
		this.insertStatement.setString(3, book.getAuthor());
		this.insertStatement.setString(4, book.getSubject());
		this.insertStatement.setFloat(5, book.getPrice());
		this.insertStatement.setInt(6, book.getIsbn());
